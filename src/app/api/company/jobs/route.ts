...
export async function POST(request: Request) {
  try {
    ...
    const parsed = jobFormSchema.safeParse({
      ...
      applicationMode: formData.get("applicationMode") || "weldoo",
      ...
      salaryVisible: formData.has("salaryVisible") ? formData.get("salaryVisible") : "false",
    ...
    const payload = {
      ...
      materials: data.materials.length ? data.materials : data.tools,
      ...
      tools: data.tools,
      welding_processes: data.weldingProcesses.length ? data.weldingProcesses : data.skills,
